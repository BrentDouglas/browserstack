...
public class Http {
    ...
    public static class HttpRequestImpl implements Request {
        ...
        protected Response processResponse(final HttpURLConnection conn) throws IOException {
            ...
            if (responseCode != HttpURLConnection.HTTP_OK) {
                ...
                try {
                    ...
                    return new ResponseImpl(responseCode, read(stream), conn.getHeaderFields());
                } finally {
                    if (stream != null) {
                        stream.close();
                    }
        ...
        protected byte[] read(final InputStream in) throws IOException {
    ...
    public static class ResponseImpl implements Response {
        ...
        public ResponseImpl(final int code, final byte[] data, final Map<String, List<String>> headers) {
            this.code = code;
            this.data = data;
